        ...
        Column(
            ...
            Row(
                ...
                Switch(
                    ...
                    onCheckedChange = {
                        musicIsChecked=it
                        PreferenceManager.savePreferenceMusicOnOff(context,it)
                        Toast.makeText(context, "ha cambiado la musica: "+musicIsChecked,Toast.LENGTH_LONG).show()
                    },
                    /*thumbContent = {
                        Icon(
